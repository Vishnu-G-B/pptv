<script>
    ...
    // import FullWidthText from "$lib/components/common/FullWidthText.svelte";
    import {onMount} from "svelte";
    // import conscious_ott from "$lib/images/conscious_ott.png";
    // import feature_your_film from "$lib/images/feature_your_film.png";
    // import childrens_perspective from "$lib/images/childrens_perspective.png";
    // import make_a_difference from "$lib/images/make_a_difference.png";
    // import Waves from "$lib/components/common/Waves.svelte";

    const imageModules = import.meta.glob('$lib/images/top10Posters/*', {
        eager: true, // Load immediately (not lazy-loaded)
        as: 'url'    // Import as URL strings
    });

    // Extract the URL values into an array
...
<div class="min-h-screen h-fit w-full flex flex-col relative bg-gray-100 overflow-hidden wow-card-trigger">
    ...
    <div class="h-screen w-full flex flex-col items-center justify-center z-[2] relative mt-24" style="user-select: none">
        <div class="h-screen w-full absolute top-0 flex items-center justify-center blur-xl">
            ...
            <div class="h-full w-full flex items-center justify-center absolute">
                <img src="{movieCardsPosters[currentIndexMovieCarousel]}" alt="" class="h-full w-full object-contain">
            </div>
                    ...
                    <div class="h-full w-full">
                        <div class="h-full w-full relative">
                            <img src="{movieCardsPosters[index]}" alt="photo of all the avengers"
                                 class="w-full h-full object-cover opacity-[0.95]" style="filter: {currentIndexMovieCarousel === index ? '': 'grayscale(100%) sepia(100%) hue-rotate(260deg)'};">
