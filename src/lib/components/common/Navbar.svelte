...
<div class="w-[295px] h-screen fixed left-0 top-0 z-[4]">
    <div class="w-fit h-full desktop-nav-container backdrop-blur-sm flex flex-col items-start justify-center p-3 px-5 gap-5"
        ...
        <div class="w-fit h-fit flex flex-row gap-2 items-center justify-center group">
            ...
            <div class="text-lg primary-font -translate-x-[100%] text-on-surface hidden desktop-nav-links-description opacity-0 text-nowrap text-clip">
                Home
                <div class="h-2 w-0 group-hover:w-full bg-primary/80 absolute bottom-0 transition-all duration-300"></div>
            </div>
        </div>
        <div class="w-fit h-fit flex flex-row gap-2 items-center justify-center relative group">
