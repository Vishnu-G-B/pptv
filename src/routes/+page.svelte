...
<div class="min-h-screen h-fit w-full flex flex-col relative bg-background wonderfull-trigger items-start justify-start pt-5">
    ...
    <div class="h-screen w-full flex-col items-center justify-center hidden lg:flex gap-2 sticky top-0">
        ...
        <div class="flex flex-row w-full gap-5 px-10 mt-10 max-w-[1100px]">
            <p class="text-lg xl:text-xl font-light text-surface w-1/2">
            ...
            <p class="text-lg xl:text-xl font-light text-surface w-1/2">
                These films are carefully analyzed and transformed into <span
                    class="text-brand-orange font-bold italic">impactful lesson plans </span>by our team of academic
                experts.
                Paired with activity- based modules, the films seamlessly blend storytelling with critical
                themes.
            </p>
            <p class="text-lg xl:text-xl font-light text-surface w-1/2">
                Together, these films and modules create a rich educational experience that inspires learning,
                fosters empathy, and <span class="text-brand-orange italic font-bold">empowers children </span>to
